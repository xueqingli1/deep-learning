...
def unit_test_values(testcase):
    if testcase == 'rnn':
        return torch.FloatTensor([[-0.7232, -2.0638, -1.3116],
        [-0.7716, -2.0406, -1.2758],
        [-0.8598, -1.9441, -1.1287],
        [-1.0351, -1.7032, -0.7990],
        [-1.2771, -1.2921, -0.5187]]), torch.FloatTensor(
            [[-0.9717, 0.9257, -0.9781, 0.9998],
             [-0.8943, 0.9526, -0.9394, 0.9994],
             [-0.6433, 0.9699, -0.8381, 0.9977],
             [-0.0845, 0.9810, -0.6024, 0.9915],
             [0.5330, 0.9880, -0.1771, 0.9690]]
        )
